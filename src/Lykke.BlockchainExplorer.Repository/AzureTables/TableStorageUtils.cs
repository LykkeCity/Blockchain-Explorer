...
namespace Lykke.BlockchainExplorer.Repository.AzureTables
{
    internal enum ToIntervalOption
    {
        IncludeTo,
        ExcludeTo
    }

    internal enum RowKeyDateTimeFormat
    {
        Iso,
        Short
    }
    ...
    internal static class TableStorageUtils
    {
        ...
        internal static class QueryGenerator<T> where T : ITableEntity, new()
        {
